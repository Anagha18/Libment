...
//{
$sql = "UPDATE librarydatabase.librarian SET Lib_Id='$lid', Lib_Name='$ln', Lib_psswd='$lp' WHERE Lib_Id='$lid'";
$sql1 = "UPDATE  librarydatabase.libr_location SET Li_Id='$lid', Li_Loc='$lloc' WHERE Li_Id='$lid'";
$result = mysqli_query($connection,$sql);
